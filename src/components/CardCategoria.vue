...
export default {
    props: { // props é um obj
        categoria: {type: Object as PropType<ICategoria>, required: true} // categoria é uma propiedade do obj props
    },
        ...
        <ul class="categoria__ingredientes">
            <li v-for="ingrediente in categoria.ingredientes" :key="ingrediente" >
                <IngredienteSelecionavel 
                  ...
                  v-on:adicionarIngrediente="$emit('adicionarIngrediente', $event)"
                />
            </li>
        </ul>
    </article>
